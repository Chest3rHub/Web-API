...
public partial class _TravelDbContext : DbContext
{
    ...
    protected _TravelDbContext()
    {
    }

    public _TravelDbContext(DbContextOptions options) : base(options)
    {
    }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
    //    modelBuilder.HasDefaultSchema("s24684");
